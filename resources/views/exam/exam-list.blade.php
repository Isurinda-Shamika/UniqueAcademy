                        ...
                        <tbody>
                            ...
                            @foreach ($Data as $exe)
                                <tr>
                                    ...
                                    <td> <a href="{{url('edit-exam/'.$exe->id)}}" class="btn btn-primary"> Edit</a> | <a href="{{url('delete-exam/'.$exe->id)}}" class="btn btn-danger"> Delete</a> | <a href="{{url('exam/' . $exe->id)}}" class="btn btn-info"> View</a>
